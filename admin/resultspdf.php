...
$pdf->Cell(1.89, .20, 'POLL CHAIRMAN', 0, 0, 'C'); // Change string (name)
$pdf->Cell(0.3, .20, '', 0, 0, 'C');
$pdf->Cell(1.89, .20, 'POLL SECRETARY/CLERK', 0, 0, 'C'); // Change string (name)
$pdf->Cell(0.3, .20, '', 0, 0, 'C');
$pdf->Cell(1.89, .20, 'MEMBER', 0, 1, 'C'); // Change string (name)
